<nav class="nav p-3 desktop_Nav_Display text-left">   
        ...
        <!-- Dashboard -->
        <div class="row w-100">
            <div id="dropdown_Header_00" class="col-12">
              <h2 class="mb-0 ">                                 
        ...
        <!-- Posts -->
       <div class="row w-100">
            <div class="col-12 accordion m-0" id="accordion_Posts">
        ...
        <!-- Users -->  
       <div class="row w-100">     
            <div class="col-12 accordion m-0" id="accordion_Users">
                    ...
                    <div id="dropdown_Header_04">
                      <h2 class="mb-0">                                 
                        <button class="btn text-light p-0" id="users_Btn" type="button" data-toggle="collapse" data-target="#accordion_Menu_04" aria-expanded="true" aria-controls="accordion_Menu_04">
                          <a class="nav-link dropdown-toggle active text-light py-auto" href="#"><img src="images/icons/many-people-outline-light.png" class="mx-2" alt="" style="width: 15px;">Users</a>
                        </button> <!-- /. -->
                      </h2> <!-- /. -->
                    </div> <!-- /. -->
        ...
        <!-- Profile -->
        <div class="row w-100">
            <div id="dropdown_Header_05" class="col-12">
              <h2 class="mb-0 ">                                 
        ...
        <!-- DEV ACCESS - ADMIN AREA -->
        <div class="row w-100">
            <div id="dropdown_Header_06" class="col-12">
              <h2 class="mb-0 ">                                 
                <button class="btn text-light p-0" id="home_Btn" type="button">
